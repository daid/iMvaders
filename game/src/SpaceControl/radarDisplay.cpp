...
RadarDisplay::RadarDisplay(P<EnergyGrid> grid, P<SpaceObject> owner)
...
void RadarDisplay::update(float delta)
{
...
void RadarDisplay::render(sf::RenderTarget& window)
{
...
bool RadarDisplay::checkVisible(P<SpaceObject> o)
{
    if (o->alwaysVisible)
        return true;
